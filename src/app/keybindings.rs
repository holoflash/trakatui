        ...
        Self {
            bindings: vec![
                ...
                Binding {
                    ...
                    title: "Input octave down",
                    description: "Lower the keyboard octave",
                    category: "Edit",
                },
                Binding {
                    action: Action::InputTransposeUp,
                    combo: KeyCombo::new(Key::Period).shift(),
                    title: "Input transpose +1",
                    description: "Raise the input transpose by one semitone",
                    category: "Edit",
                },
                Binding {
                    action: Action::InputTransposeDown,
                    combo: KeyCombo::new(Key::Comma).shift(),
                    title: "Input transpose −1",
                    description: "Lower the input transpose by one semitone",
                    category: "Edit",
                },
                Binding {
                    ...
                    title: "Transpose +1",
                    description: "Transpose selected note(s) up by one semitone",
                    category: "Edit",
                },
                Binding {
                    ...
                    title: "Transpose −1",
                    description: "Transpose selected note(s) down by one semitone",
                    category: "Edit",
                },
                Binding {
                    ...
                    title: "Transpose +12",
                    description: "Transpose selected note(s) up by one octave",
                    category: "Edit",
                },
                Binding {
                    ...
                    title: "Transpose −12",
                    description: "Transpose selected note(s) down by one octave",
                    category: "Edit",
                },
                Binding {
